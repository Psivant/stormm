// -*-c++-*-
#ifndef STORMM_PRESENT_ANALYSIS_H
#define STORMM_PRESENT_ANALYSIS_H
...
void createAnalysisReport(const UserSettings &ui,
                          const DynamicsIntervention &mm_intv = dyna_tk);
