    ...
    for (int pos = 0; pos < nrbond; pos++) {
      ...
      const double contrib =
        evalBondRestraint<double,
                          ...
                          double,
                          double2,
                          double4_16a>(i_atom, j_atom, step_number, rar.rbond_init_step[param_idx],
    ...
    for (int pos = 0; pos < nrangl; pos++) {
      ...
      const double contrib =
        evalAnglRestraint<double,
                          ...
                          double,
                          double2,
                          double4_16a>(i_atom, j_atom, k_atom, step_number,
    ...
    for (int pos = 0; pos < nrdihe; pos++) {
      ...
      const double contrib =
        evalDiheRestraint<double,
                          ...
                          double,
                          double2,
                          double4_16a>(i_atom, j_atom, k_atom, l_atom, step_number,
